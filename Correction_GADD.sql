...
DELETE FROM mckinsey_user.IT_MK_DAILY_FISRT_CALL_GLOBAL@mkdblink k
WHERE k.ACTIVATION_DATE BETWEEN to_date('25/03/2020','dd/mm/yyyy') and to_date('25/03/2020','dd/mm/yyyy');
...
from report_user.IT_MK_RGS_TRACKING_REPORT b,(SELECT a.REPORT_DATE REPORT_DATE,a.TOTAL_FIRST_CALL TOTAL_FIRST_CALL
                                    ...
                                    where a.REPORT_DATE=TO_DATE('25/03/2020','dd/mm/yyyy')) c
where b.periods=c.REPORT_DATE
and b.OPERATORS='Areeba'
and b.periods =TO_DATE('25/03/2020','dd/mm/yyyy')

 
 select count(distinct MSISDN)
FROM  report_user.IT_MIS_RGS90_CHURN_GROSSADD
WHERE  RGS_TYPE = 'RECO'
AND report_date =TO_DATE('25/03/2020','dd/mm/yyyy')


select 1688-957 from dual
...
WHERE a.DAILY_CONSO BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');

COMMIT;

DELETE FROM REPORT_USER.IT_MIS_DAILY_FC_WINBACK b
WHERE b.FC_DATE_RECO BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');

COMMIT;


DELETE FROM REPORT_USER.IT_MIS_DAILY_FISRT_CALL_GLOBAL d
WHERE d.ACTIVATION_DATE BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');

COMMIT;
 
DELETE FROM REPORT_USER.IT_MIS_DAILY_WINBACK_GLOBAL e
WHERE e.FC_DATE_RECO BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');

COMMIT;

DELETE FROM REPORT_USER.IT_MIS_DAILY_FC_GLOBAL f
WHERE f.DAILY_CONSO BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');

COMMIT;

DELETE FROM REPORT_USER.IT_MIS_DAILY_GROSS_ADD g
WHERE g.DAILY_CONSO BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');

COMMIT;

DELETE FROM REPORT_USER.IT_MIS_DAILY_FC_REPARTITION h
WHERE h.FC_DATE BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');

COMMIT;

DELETE FROM REPORT_USER.IT_MIS_DAILY_GROSS_ADD_ADJUST i
WHERE i.ACTIVATION_DATE BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');

COMMIT;


DELETE FROM REPORT_USER.IT_MIS_DAILY_FC_REPART_REPT c
WHERE c.DAILY_CONSO BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');

COMMIT;

DELETE FROM REPORT_USER.IT_MIS_DAILY_FC_REPART_GLOBAL l
WHERE l.ACTIVATION_DATE BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');

COMMIT;

DELETE FROM REPORT_USER.IT_MIS_DAILY_FC_REPARTITION2 m
WHERE m.FC_DATE BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');

COMMIT;

DELETE FROM REPORT_USER.IT_MIS_DAILY_FIRST_CALL_ADJUST n
WHERE n.ACTIVATION_DATE BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');

COMMIT;


DELETE FROM REPORT_USER.IT_MIS_DAILY_FC_GLOBALH j
WHERE j.ACTIVATION_DATE BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');

COMMIT;

DELETE FROM REPORT_USER.IT_MIS_DAILY_FC_REPART_GLOBALH o
WHERE o.ACTIVATION_DATE BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');
...
WHERE daily_conso BETWEEN TO_DATE('25/03/2020','dd/mm/yyyy') and TO_DATE('25/03/2020','dd/mm/yyyy');
...
CURSOR CURRENT_DATE IS 
   ...
   -- and to_date(a.name,'dd/mm/yyyy')  between to_date(to_char(sysdate-1,'dd/mm/yyyy'),'dd/mm/yyyy') and to_date(to_char(sysdate-1,'dd/mm/yyyy'),'dd/mm/yyyy') 
    and to_date(name,'dd/mm/yyyy')  between  to_date('25/03/2020','dd/mm/yyyy') and to_date('25/03/2020','dd/mm/yyyy') 
...
where to_char(REPORT_DATE,'yyyymmdd')=record_current_date.NAME; -- =to_date('25/03/2020','dd/mm/yyyy');
...
DELETE FROM IT_MK_DAILY_FC_REPART_GLOBAL@MKDBLINK p
WHERE p.ACTIVATION_DATE BETWEEN to_date('25/03/2020','dd/mm/yyyy') and to_date('25/03/2020','dd/mm/yyyy');
